...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Label
      ref={ref}
      className={cn(error && "text-destructive text-red-600 dark:text-red-400", className)}
      htmlFor={formItemId}
      {...props}
    />
  );
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <p
      ref={ref}
      id={formMessageId}
      className={cn("text-sm font-medium text-destructive text-red-600 dark:text-red-400", className)}
      {...props}
    >
      {body}
    </p>
